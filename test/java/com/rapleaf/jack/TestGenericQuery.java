...
public class TestGenericQuery {
  ...
  public void testGetMethodsForRecordsWithNullValues() throws Exception {
    ...
    byteArrays = results1.gets(User.SOME_BINARY);
    assertArrayEquals(new byte[]{(byte)3}, byteArrays.get(0));
    assertArrayEquals(new byte[]{(byte)4}, byteArrays.get(1));
    assertArrayEquals(new byte[]{(byte)5}, byteArrays.get(2));
    ...
    doubles = results1.gets(User.SOME_FLOAT);
    assertEquals(1.1, doubles.get(0), DELTA);
    assertEquals(1.2, doubles.get(1), DELTA);
    assertEquals(1.3, doubles.get(2), DELTA);

    assertEquals(Lists.newArrayList(true, false, true), results1.getBooleans(User.SOME_BOOLEAN));
    assertEquals(Lists.newArrayList(true, false, true), results1.gets(User.SOME_BOOLEAN));
    ...
    assertEquals(
        Lists.newArrayList(null, null, null),
        results1.gets(User.SOME_DATETIME)
    );
    ...
    assertEquals(
        Lists.newArrayList(null, null, null),
        results1.gets(User.SOME_DECIMAL)
    );
  }
