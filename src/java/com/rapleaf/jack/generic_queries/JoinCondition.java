...
public class JoinCondition implements QueryCondition {
  ...
  public JoinCondition(Class<? extends ModelWithId> model, ModelField modelField1, ModelField modelField2) {
    this.model = model;
  ...
  public String getSqlStatement() {
    return "JOIN " + Utility.getTableName(model) + " ON " + modelField1.getSqlKeyword() + " = " + modelField2.getSqlKeyword();
  }
}
